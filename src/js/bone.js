 (function(root, Bone, _, $) { 
  var  Bone = root.Bone ={};
  var slice = Array.prototype.slice; 
  Bone.$ = $; 
  Bone.emulateHTTP = false; 
  Bone.emulateJSON = false; 
  ...
  // Allow the `Bone` object to serve as a global event bus, for folks who
  // want global "pubsub" in a convenient place.
  _.extend(Bone, Events);

  // Bone.Model
  // -------------- 
  var Model = Bone.Model = function(attributes, options) {
  ...
  _.extend(Model.prototype, Events, {
    ...
    // Proxy `Bone.sync` by default -- but override this if you need
    // custom syncing semantics for *this* particular model.
    sync: function() {
      return Bone.sync.apply(this, arguments);
    },
    ...
    // using Bone's restful methods, override this to change the endpoint
    // that will be called.
    url: function() {
      var base =
  ...
  _.extend(View.prototype, Events, {
    ...
    // applicable Bone.Events listeners.
    remove: function() {
      this._removeElement();
      this.stopListening();
      return this;
  ...
  Bone.sync = function(method, model, options) {
    ...
    var xhr = options.xhr = Bone.ajax(_.extend(params, options));
  ...
  // Set up all inheritable **Bone.History** properties and methods.
  _.extend(History.prototype, Events, {
    ...
    getParam: function (param) {
        ...
        return (rstArr !== null ) ? decodeURIComponent(rstArr[2]) : '';
    },
    ...
    // Disable Bone.history, perhaps temporarily. Not useful in a real app,
  ...
  // Create the default Bone.history.
...
_.extend(Bone.Object.prototype, Bone.Events, {
    ...
    destroy: function() {
        ...
        this.trigger.apply(this, ['destroy', this].concat(args));
        this.stopListening();
        return this;
    }
  ...
  return Bone;
}(window, window._ , window.jQuery || window.Zepto));

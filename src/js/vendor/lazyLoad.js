...
;(function($,window,document){
    ...
    if(!$.fn.hasOwnProperty('imglazyload')){
        $.fn.imglazyload = $.fn.lazyload; 
    }
    window.lazyload = window.lazyload || $.fn.lazyload;

    if ( typeof define === 'function' && typeof window.seajs !='undefined') {
